...
class MarvellousLogin extends Template implements ActionListener, Runnable
{
	...
	MarvellousLogin()
	{
		...
		TopLabel.setText("Marvellous Packer Unpacer : Login");
	...
	public boolean Validate(String Username,String password)
	{
		...
		{
			JOptionPane.showMessageDialog(this,"Please enter Username","Marvellous Packer Unpacker",JOptionPane.ERROR_MESSAGE);
			return false;
		}
		else if(password.length() == 0)
		{
			JOptionPane.showMessageDialog(this,"Please enter password","Marvellous Packer Unpacker",JOptionPane.ERROR_MESSAGE);
			return false;
		}
